...
public ReadableCategory getByfriendlyUrl(
	...
	@GetMapping(value = { "/private/category/unique" })
@Operation(summary = "Check if category code already exists", description = "")
...
public ReadableCategoryList list(
	...
	@Operation(summary = "Get category by product", description = "")
public ReadableCategoryList list(
