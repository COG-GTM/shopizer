...
public class CatalogApi {
  ...
  @Operation(summary = "Get catalogs by merchant", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @GetMapping(value = {"/private/catalog/unique"})
  @Operation(summary = "Check if catalog code already exists", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Create catalog", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Update catalog", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Get catalog", description = "")
  ...
  @Operation(summary = "Deletes a catalog", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Add catalog entry to catalog", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Remove catalog entry from catalog", description = "")
  ...
  @ResponseStatus(HttpStatus.OK)
  @Operation(summary = "Get catalog entry by catalog", description = "")
