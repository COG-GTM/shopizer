...
public class AuthenticateCustomerApi {
    ...
    @Operation(summary = "Authenticates a customer to the application", description = "Customer can authenticate after registration")
    @ResponseBody
    ...
    @Operation(summary = "Sends a request to reset password")
