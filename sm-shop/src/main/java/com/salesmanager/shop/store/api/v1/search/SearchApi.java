...
@Tag(name = "Search products and search word/sentence completion funct...", description = "Search products and search word/sentence completion functionality (Search Api)")
