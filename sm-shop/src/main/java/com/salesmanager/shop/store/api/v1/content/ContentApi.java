...
@Tag(name = "Content management resource", description = "Content management resource (Content Management Api)")
public class ContentApi {
	...
	@Operation(summary = "Get all content for a given MerchantStore")
	...
	@Operation(summary = "Deletes a content from CMS")
	...
	@Operation(summary = "Deletes a file from CMS")
