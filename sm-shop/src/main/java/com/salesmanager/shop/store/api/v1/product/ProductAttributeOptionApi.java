...
public @ResponseBody ReadableProductOptionEntity createOption(
	...
	@GetMapping(value = { "/private/product/option/unique" })
@Operation(summary = "Check if option code already exists", description = "")
	...
	@ResponseStatus(HttpStatus.OK)
	@GetMapping(value = { "/private/product/option/value/unique" })
@Operation(summary = "Check if option value code already exists", description = "")
...
@Operation(summary = "Get product attributes", description = "")
