...
public class ProductTypeApi {
	...
	@GetMapping(value = "/private/product/types")
...
public ReadableProductTypeList list(@RequestParam(name = "count", defaultValue = "10") int count,
	...
	@GetMapping(value = "/private/product/type/{id}")
	@Operation(summary = "Get product type", description = "")
public ReadableProductType get(@PathVariable Long id, @Parameter(hidden = true) MerchantStore merchantStore,
	...
	@GetMapping(value = "/private/product/type/unique")
	@Operation(summary = "Verify if product type is unique", description = "")
public ResponseEntity<EntityExists> exists(@RequestParam String code, @Parameter(hidden = true) MerchantStore merchantStore,
	...
	@PostMapping(value = "/private/product/type")
	@Operation(summary = "Create product type", description = "")
public Entity create(@RequestBody PersistableProductType type, @Parameter(hidden = true) MerchantStore merchantStore,
	...
	@PutMapping(value = "/private/product/type/{id}")
	@Operation(summary = "Update product type", description = "")
public void update(@RequestBody PersistableProductType type, @PathVariable Long id,
	...
	@DeleteMapping(value = "/private/product/type/{id}")
	@Operation(summary = "Delete product type", description = "")
