...
public ReadableProductPrice price(@PathVariable final Long id,
	...
	**/
	...
	@Operation(summary = "Get a product by friendlyUrl (slug)", description = "For administration and shop purpose. Specifying ?merchant is "
...
public ReadableProduct getByfriendlyUrl(@PathVariable final String friendlyUrl,
	...
	@ResponseStatus(HttpStatus.OK)
	@GetMapping(value = { "/private/product/unique" })
@Operation(summary = "Check if product code already exists", description = "")
