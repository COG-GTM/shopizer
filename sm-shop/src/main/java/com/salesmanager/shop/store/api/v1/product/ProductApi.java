...
@Tag(name = "Product definition resource (Create udtate and delete product definition. Serves api v1 and v2 with backward compatibility)")
public class ProductApi {
	...
	**/
	...
	@Operation(summary = "Get product by friendly URL", description = "For administration and shop purpose. Specifying ?merchant is required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "Single product found") })
	@ResponseBody
	@Parameters({ @Parameter(name = "store", description = "store", example = "DEFAULT"),
