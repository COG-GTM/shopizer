...
public @ResponseBody Entity create(
	...
	@Operation(summary = "Update product instance group", description = "")
	...
	@Operation(summary = "Get product instance group", description = "")
	...
	@Operation(summary = "Delete product instance group", description = "")
