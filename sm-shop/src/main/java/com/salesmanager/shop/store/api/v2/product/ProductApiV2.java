...
@Tag(name = "Product display and management resource", description = "Product display and management resource (Product display and Management Api such as adding a product to category. Serves api v1 and v2 with backward compatibility)")
public class ProductApiV2 {
	...
	@Operation(summary = "Get product by friendly URL v2")
	@ResponseBody
