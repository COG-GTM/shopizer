...
@Tag(name = "Product display and management resource (Product display and Management Api such as adding a product to category. Serves api v1 and v2 with backward compatibility)")
public class ProductApiV2 {
	...
	@Parameters({ 
			@Parameter(name = "store", description = "store", example = "DEFAULT"),
			@Parameter(name = "lang", description = "lang", example = "en") })
	...
	@Parameters({ @Parameter(name = "store", description = "store", example = "DEFAULT"),
			@Parameter(name = "lang", description = "lang", example = "en") })
	...
	@Operation(summary = "Get product by friendly URL version 2", description = "For shop purpose. Specifying ?merchant is required otherwise it falls back to DEFAULT")
	@ApiResponses(value = {
