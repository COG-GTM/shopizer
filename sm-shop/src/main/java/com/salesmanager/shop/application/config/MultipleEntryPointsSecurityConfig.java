 ...
 * Migrated from WebSecurityConfigurerAdapter to SecurityFilterChain (Spring Security 6)
 */
@Configuration
@EnableWebSecurity
public class MultipleEntryPointsSecurityConfig {
	...
	public SecurityFilterChain customerFilterChain(HttpSecurity http,
			UserDetailsService customerDetailsService) throws Exception {
		http
	...
	@Bean
	@Order(2)
	public SecurityFilterChain servicesApiFilterChain(HttpSecurity http,
	...
	public AuthenticationManager jwtCustomerAuthenticationManager(UserDetailsService jwtCustomerDetailsService) {
		JWTCustomerAuthenticationProvider provider = new JWTCustomerAuthenticationProvider();
		provider.setUserDetailsService(jwtCustomerDetailsService);
		return new ProviderManager(provider);
	}
